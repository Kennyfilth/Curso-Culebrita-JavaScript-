...
let CSS_CLASE_SACUDIR_HORINZONTALMENTE = "shake-horizontal";
...
function gameOver() {
    ...
    CONTENEDOR_NINTENDO.classList.add(CSS_CLASE_SACUDIR_HORINZONTALMENTE);
}
...
function empezarJuego() {
     ...
     CONTENEDOR_NINTENDO.classList.remove(CSS_CLASE_SACUDIR_HORINZONTALMENTE);
